                ...
                <TableBody>
                  {users.map((u) => (
                    <TableRow key={u.id}>
                      ...
                      <TableCell className="text-muted-foreground hidden md:table-cell">{formatDate(u.created_at)}</TableCell>
                      <TableCell className="text-muted-foreground hidden lg:table-cell">{formatDate(u.last_sign_in_at)}</TableCell>
                      <TableCell>
